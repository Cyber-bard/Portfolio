...
<html>
	...
	<div class="form-group text-right">
			<button class='btn' name='submit'><a href="index.html">Home</a></button>
		</div>
	</nav>
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h3 style="font-family: Noto Sans;">Register to </h3><h4 style="font-family: Noto Sans;">Online Quiz System</h4></center><br>
